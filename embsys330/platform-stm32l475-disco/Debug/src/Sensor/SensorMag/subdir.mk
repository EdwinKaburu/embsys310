...
CPP_SRCS += \
../src/Sensor/SensorMag/SensorMag.cpp 

OBJS += \
./src/Sensor/SensorMag/SensorMag.o 

CPP_DEPS += \
./src/Sensor/SensorMag/SensorMag.d 


# Each subdirectory must supply rules for building sources it contributes
src/Sensor/SensorMag/%.o: ../src/Sensor/SensorMag/%.cpp src/Sensor/SensorMag/subdir.mk
	@echo 'Building file: $<'
